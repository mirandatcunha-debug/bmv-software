    ...
    <div className="space-y-6 animate-in">
      ...
      <div>
        ...
        <p className="text-muted-foreground">
          Gerencie suas receitas, despesas, contas a pagar e receber.
        </p>
      </div>
          ...
          <CardContent className="p-6">
            <div className="flex items-center gap-4">
              <div className="p-2 rounded-lg bg-bmv-primary/10">
                <Wallet className="h-5 w-5 text-bmv-primary" />
              </div>
              <div>
        ...
        <CardContent>
          <div className="text-center py-12">
            ...
            <p className="text-muted-foreground max-w-md mx-auto">
              O módulo Financeiro está sendo desenvolvido e em breve você poderá
              gerenciar todas as suas finanças de forma completa e integrada.
            </p>
          </div>
        </CardContent>
      </Card>
